...
esp_err_t hw_servo_init(uint8_t gpio_num) {
    ...
    ret = (gpio_num == 19) ? ledc_timer_config(&ledc_timer) : ESP_OK; //Medida para configurar o timer somente uma unica vez
